...
resource "libvirt_pool" "ubuntu" {
  name = "ubuntu"
  type = "dir"
  path = "/data/terraform-provider-libvirt-pool-ubuntu"
}
...
resource "libvirt_domain" "k8s-node01" {
  name   = "k8s-node01-ubuntu"
  memory = "4096"
  vcpu   = 2
...
resource "libvirt_domain" "k8s-node02" {
  name   = "k8s-node02-ubuntu"
  memory = "4096"
  vcpu   = 2
